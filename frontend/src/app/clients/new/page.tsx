    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <PageHeader
          ...
          description="Complete la información para dar de alta un nuevo cliente en el sistema."
        />
      </div>
      ...
      <form className="space-y-6">
        <div className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
          ...
          <div className="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8 bg-slate-50 rounded-b-xl">
            <Link
              href="/clients"
