...
function ClientDetailPage() {
    ...
    const id = params?.id;
    const { data: clientData, isLoading: isLoadingClient, error: errorClient } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "client",
            id
        ],
        queryFn: {
            "ClientDetailPage.useQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].clients.get(id)
        }["ClientDetailPage.useQuery"],
        enabled: !!id
    });
    const { data: accountsData, isLoading: isLoadingAccounts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "clientAccounts",
            id
        ],
        queryFn: {
            "ClientDetailPage.useQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].clients.getAccounts(id)
        }["ClientDetailPage.useQuery"],
        enabled: !!id
    });
...
_s(ClientDetailPage, "sAzFvb4Odu3wTC3mHi1hqASbZEM=", false, function() {
    return [
...
//# sourceMappingURL=_d3241ea4._.js.map